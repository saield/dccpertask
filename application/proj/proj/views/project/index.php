    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url(file:///B|/mca/sem4/web%20tech/birthday_bash/images/slide/slide1.jpg);"></div>
                <div class="carousel-caption">
                    <h5>Birthday Candles</h5>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url(file:///B|/mca/sem4/web%20tech/birthday_bash/images/slide/slide2.jpg);"></div>
                <div class="carousel-caption">
                    <h5>Celebrate with us</h5>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url(file:///B|/mca/sem4/web%20tech/birthday_bash/images/slide/slide3.jpg);"></div>
                <div class="carousel-caption">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="file:///B|/mca/sem4/web tech/birthday_bash/portfolio-item.html">

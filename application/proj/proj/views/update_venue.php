                ...
                <form name="sentMessage" id="contactForm" novalidate action="http://localhost/CodeIgniter-3.0.0/index.php/birthday_controller/update_venue" method="post" enctype="multipart/form-data">
					...
					<div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="hidden" value="<?php echo $row->venue_id; ?>" name="id" class="form-control" id="name" required data-validation-required-message="Please enter your name.">
                    ...
                    <div class="control-group form-group">
					  ...
					  <div class="control-group form-group">
                        <div class="controls">
                            <label>Address:</label>
                            <input type="text" value="<?php echo $row->address; ?>" name="price" class="form-control" id="email" required data-validation-required-message="Please enter Price">
                        </div>
                    </div>
					<div class="control-group form-group">
                        <div class="controls">
                            <label>Capacity:</label>
                            <input type="number" value="<?php echo $row->capacity; ?>" name="price" class="form-control" id="email" required data-validation-required-message="Please enter Price">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
					...
					<div class="control-group form-group">
                        <div class="controls">
                            <label>Picture:</label>
                            <input type="file" value="<?php echo $row->image; ?>" name='fileUpload' class="form-control" id="email" required data-validation-required-message="Please enter ">
                        </div>
                    </div>
				<!--	<div class="control-group form-group">
                        <div class="controls">

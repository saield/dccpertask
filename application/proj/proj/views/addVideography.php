...
<head>
    ...
    <div class="container">
		...
		<div class="row">
            <div class="col-md-8">
                <h3>Add videography</h3>
				<hr>
                <form name="sentMessage" id="contactForm" novalidate action="http://localhost/CodeIgniter-3.0.0/index.php/birthday_controller/AddVideography/videography/addVideography" method="post" enctype="multipart/form-data">

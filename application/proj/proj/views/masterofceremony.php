...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Master Of Ceremony                    <small></small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.html">Home</a>
                    </li>
                    <li class="active">Master Of Ceremony</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
       ...
       <?php   foreach ($results as $row) {
        ...
        echo '<div class="row">';
		               echo '<form  method="post" action="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/addToCart/masterofceremony">';
		   ...
		   $img=$row->image;
            ...
            echo '<div class="col-md-5">';
			   ...
			   $mocid=$row->moc_id;
                                echo "<input type='hidden' name='id' value='$mocid' />";

<?php include('adminheader.php'); ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <?php echo "<form role='form' name ='add cake' method='post' action='http://localhost/codeigniter-3.0.0/index.php/birthday_controller/addVideography/$table/$table' enctype='multipart/form-data'>" ?>

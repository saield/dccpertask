...
<body>
        ...
        <div class="row border">
            ...
            <div class="col-md-4 img-portfolio">
                <a href="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/services/decor">
                    <img class="img-responsive img-hover" src="http://localhost/CodeIgniter-3.0.0/images/services/deco.jpg" alt="">
                </a>
                <h3>
                    <a href="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/services/decor">Design & Decor</a>
                </h3>
        ...
        <div class="row border">
            ...
            <div class="col-md-4 img-portfolio">
                ...
                <p>M bored writing all dis. Please complete it. :(</p>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row border">
            <div class="col-md-4 img-portfolio">
                <a href="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/services/pickDrop">
                    <img class="img-responsive img-hover" src="http://localhost/CodeIgniter-3.0.0/images/services/pickdrop.jpg" alt="">
                </a>
                <h3>
                    <a href="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/services/pickDrop">Pick & Drop Service</a>
                </h3>
                <p>M bored writing all dis. Please complete it. :(</p>
            </div>
            <div class="col-md-4 img-portfolio">

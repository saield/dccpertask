    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user">&nbsp;</i>logout<b class="caret"></b></a>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/tabs/adminperformanceadd">Performances</a>
                            </li>
                            <li>

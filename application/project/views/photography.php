...
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Photogarpht</li>
                </ol>
            </div>
        </div>
 ...
 <form name="refine" method="post" action="<?php echo base_url(); ?>index.php/birthday_controller/searchD/photography">
        ...
        <div class="input-group" position="relative" style="padding:5px;">
            ...
            <div class="category" id="price" style="display:none; padding-left:10px">
                <input type="radio" name="pricer" id="checkbox_id"  value="0,3000">
                <span for="checkbox_id">below 3000 </span></br>
                <input type="radio" name="pricer" id="checkbox_id" value="3000,4000">
                <span for="checkbox_id">3000-4000</span></br>
                <input type="radio" name="pricer" id="checkbox_id" value="4000,5000">
                <span for="checkbox_id">4000-5000 </span></br>
                <input type="radio" name="pricer" id="checkbox_id" value="5000,15000">
                <span for="checkbox_id">above 5000 </span></br>
            </div>
        </div>
...
foreach ($results as $row) {
        ...
        echo '<div class="row">';
                               echo '<form  method="post" action="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/addToCart/photography">';

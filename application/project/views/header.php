    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>index.php/birthday_controller/tabs/home">Birthday Bash</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <a href="<?php echo base_url() ?>index.php/birthday_controller/tabs/login">Login</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->

...
?>
 ...
 <form name="refine" method="post" action="<?php echo base_url(); ?>index.php/birthday_controller/searchD/moc">
        ...
        <div class="input-group" position="relative" style="padding:5px;">
            ...
            <div class="category" id="price" style="display:none; padding-left:10px">
                ...
                <input type="radio" name="pricer" id="checkbox_id" value="5000,200000">
...
foreach ($results as $row) {
        ...
        echo '<div class="row">';
                               echo '<form  method="post" action="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/addToCart/moc">';

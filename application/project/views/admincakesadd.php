<?php include('adminheader.php'); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="nav nav-tabs">
                            ...
                            <li role="presentation"><a href="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/cakes_forupdate">Update/Delete</a></li>
                        </ul>
                    </div>
                </div><br><br>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" name ="add cake" method="post" action="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/addCake" enctype="multipart/form-data">

...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Decoration
                </h1>
                <ol class="breadcrumb">
 ...
 <form name="refine" method="post" action="<?php echo base_url(); ?>index.php/birthday_controller/searchD/decoration">
        ...
        <div class="input-group" position="relative" style="padding:5px;">
            ...
            <div class="category" id="price" style="display:none; padding-left:10px">
                ...
                <input type="radio" name="pricer" id="checkbox_id" value="3000,5000">
                <span for="checkbox_id">3000-5000</span></br>
                <input type="radio" name="pricer" id="checkbox_id" value="5000,7000">
                <span for="checkbox_id">5000-7000</span></br>
                <input type="radio" name="pricer" id="checkbox_id" value="7000,100000">
                <span for="checkbox_id">above 7000 </span></br>
...
<?php foreach ($results as $row) {
        ...
        echo '<div class="row">';
                   echo '<form  method="post" action="http://localhost/codeigniter-3.0.0/index.php/birthday_controller/addToCart/decoration">';
